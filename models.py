...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        self.deconv1 = deconv(noise_size, conv_dim, 4, 2, 0)
        self.deconv2 = deconv(conv_dim, conv_dim / 2, 4)
        self.deconv3 = deconv(conv_dim / 2, conv_dim / 4, 4)
        self.deconv4 = deconv(conv_dim / 4, 3, 4)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv4 = conv(conv_dim * 4, 1, 4, 2, 0, False)
